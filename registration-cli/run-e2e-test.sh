...
prompt_required BRIDGE_E2E_KEYCLOAK_BASE_URL "Keycloak base URL (e.g. https://keycloak.bridge.cloud.edence.health)"
prompt_required BRIDGE_E2E_ADMIN_TOKEN_URL   "Keycloak admin token URL (e.g. <base>/realms/master/protocol/openid-connect/token)"
